...
export default function Testmonial(props) {
  ...
  function surpriseHandler(){
    let randomIndex =  Math.floor(Math.random()*reviews.length);  // int he lenth 0 to n
  ...
  return (
    ...
    mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
      ...
      <div className='mt-6'>
        ...
        className='flex mx-auto justify-center bg-violet-400 hover:bg-violet-500 transition-all duration-200
